 ...
 *
 * Modified by CHEN Hao for Vulture Egg Project
 * on 20-8-13.
...
THREE.Lut.prototype = {
    ...
    setLegendLabels: function (parameters, callback) {
        ...
        spriteTitle.scale.set(1, 3.2, 1.0);

        if (this.legend.layout == 'vertical') {

            spriteTitle.position.set(this.legend.position.x + this.legend.dimensions.width * 2, this.legend.position.y + ( this.legend.dimensions.height * 0.3 ), this.legend.position.z);

        }

        if (this.legend.layout == 'horizontal') {

            spriteTitle.position.set(this.legend.position.x - 0.24 , this.legend.position.y - ( this.legend.dimensions.height * 0.1 ), this.legend.position.z);
        ...
        if (this.legend.labels.ticks > 0) {
            ...
            if (this.legend.layout == 'vertical') {
                ...
                var topPositionY = this.legend.position.y + ( this.legend.dimensions.height * 0.06 );
                var bottomPositionY = this.legend.position.y - ( this.legend.dimensions.height * 0.94 );

            }

            if (this.legend.layout == 'horizontal') {
                var topPositionX = this.legend.position.x + ( this.legend.dimensions.height * 0.8 );
                var bottomPositionX = this.legend.position.x + ( this.legend.dimensions.height * (-0.2)  );
            }
            ...
            for (var i = 0; i < this.legend.labels.ticks; i++) {
                ...
                spriteTick.scale.set(1, 2.6, 1.0);
